...
#define AP152_GPIO_LED_WLAN_2G          15
#define AP152_GPIO_LED_WLAN_5G          19
#define AP152_GPIO_LED_WPS              9
#define AP152_GPIO_LED_STATUS           17

#define AP152_GPIO_LED_WAN_INET         8
#define AP152_GPIO_LED_WAN_LINK         7
#define AP152_GPIO_LED_LAN             20




#define AP152_GPIO_BTN_RESET            5
#define AP152_GPIO_BTN_WPS_WIFI         6
...
static void __init archer_c6v2_eu_setup(void)
{
...
MIPS_MACHINE(ATH79_MACH_ARCHER_C6_V2_EU, "AP152", "TP-LINK Archer c6 v2 eu support",
	     archer_c6v2_eu_setup);
