...
#ifdef COMPRESSED_UBOOT
#if (defined(CONFIG_PRODUCT_WR1043NDV4) || defined(CONFIG_PRODUCT_AP200V1) || defined(CONFIG_PRODUCT_WR942NV1) || \
     defined(CONFIG_PRODUCT_C7V4) || defined(CONFIG_PRODUCT_C7V5) || defined(CONFIG_PRODUCT_C6V2) || defined(CONFIG_PRODUCT_WR1043NV5))
        /* compressed uboot for 9563 will hang here for some obsure reason. This is a WAR. */
        printf(CONFIG_BOARD_NAME " - Dragonfly 1.%d\n\n", (ath_reg_rd(RST_REVISION_ID_ADDRESS) & 0xf));
#else
